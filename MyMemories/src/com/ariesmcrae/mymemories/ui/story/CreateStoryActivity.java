...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private static File getOutputMediaFile(int type) {
		...
		File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), "MyMemories");
	...
	private void launchSoundIntent() {
		Log.e(LOG_TAG, "launchSoundIntent");
	...
	private void launchVideoCameraIntent() {
		...
		fragment.fileUri = videoUri; 

		videoIntent.putExtra(MediaStore.EXTRA_OUTPUT, videoUri);		
		
		int VIDEO_QUALITY_HIGH = 1;
		videoIntent.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, VIDEO_QUALITY_HIGH);	
