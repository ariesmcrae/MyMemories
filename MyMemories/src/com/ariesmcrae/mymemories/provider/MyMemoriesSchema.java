...
package com.ariesmcrae.mymemories.provider;
...
//	public static final String PROJECT_NAME = "mymemories";

	/**
	 * ConentProvider Related Constants
	 */
//	public static final String AUTHORITY = ORGANIZATIONAL_NAME + "." + PROJECT_NAME + ".mymemoriesprovider";
