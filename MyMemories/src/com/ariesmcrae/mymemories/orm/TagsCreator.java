...
public class TagsCreator {
	 ...
	 */
	public static ArrayList<TagsData> getTagsDataArrayListFromCursor(Cursor cursor) {
	...
	public static TagsData getTagsDataFromCursor(Cursor cursor) {
		...
		long rowID = cursor.getLong(cursor.getColumnIndex(MyMemoriesSchema.Tags.Cols.ID));
		long loginId = cursor.getLong(cursor.getColumnIndex(MyMemoriesSchema.Tags.Cols.LOGIN_ID));
		long storyId = cursor.getLong(cursor.getColumnIndex(MyMemoriesSchema.Tags.Cols.STORY_ID));
		String tag = cursor.getString(cursor.getColumnIndex(MyMemoriesSchema.Tags.Cols.TAG));
