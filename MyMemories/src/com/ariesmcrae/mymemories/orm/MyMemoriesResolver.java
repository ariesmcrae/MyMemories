...
public class MyMemoriesResolver {
	 ...
	 */
	public ContentProviderResult[] applyBatch(final ArrayList<ContentProviderOperation> operations) throws RemoteException,
	 ...
	 * @throws RemoteException
	 */
	public ArrayList<StoryData> queryStoryData(final String[] projection, final String selection, final String[] selectionArgs,
	 ...
	 * @throws RemoteException
	 */
	public ArrayList<TagsData> queryTagsData(final String[] projection, final String selection, final String[] selectionArgs,
	        final String sortOrder) throws RemoteException {
		// query the C.P.
	...
	public StoryData getStoryDataViaRowID(final long rowID) throws RemoteException {
		...
		ArrayList<StoryData> results = queryStoryData(null, MyMemoriesSchema.Story.Cols.ID + "= ?", selectionArgs, null);
		if (results.size() > 0) {
	...
	public TagsData getTagsDataViaRowID(final long rowID) throws RemoteException {
		String[] selectionArgs = { String.valueOf(rowID) };
		ArrayList<TagsData> results = queryTagsData(null, MyMemoriesSchema.Tags.Cols.ID + "= ?", selectionArgs, null);
		if (results.size() > 0) {
			return results.get(0);
		} else {
			return null;
