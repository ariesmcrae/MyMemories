...
package com.ariesmcrae.mymemoriescontentprovider.provider.sync;
...
import com.ariesmcrae.mymemoriescontentprovider.R;
...
public class LoginActivity extends AccountAuthenticatorActivity {
	...
	public void loginButtonPressed(View v) {
		Log.d(LOG_TAG, "onCreate() called");
		String user = mUsername.getText().toString().trim().toLowerCase(Locale.ENGLISH);
		String password = mPassword.getText().toString().trim().toLowerCase(Locale.ENGLISH);
