 ...
 * 
 */
public class MyMemoriesDataDBAdapter {

	private static final String LOG_TAG = MyMemoriesDataDBAdapter.class.getCanonicalName();

	private static final String DATABASE_NAME = "myDatabase.db";

	// ST:databaseTableVariableDeclaration:start
	static final String DATABASE_TABLE_STORY = MyMemoriesSchema.Story.TABLE_NAME;
	static final String DATABASE_TABLE_TAGS = MyMemoriesSchema.Tags.TABLE_NAME;
	...
	private static final String Story_KEY_ID = MyMemoriesSchema.Story.Cols.ID;
	private static final String Story_LoginId = MyMemoriesSchema.Story.Cols.LOGIN_ID;
	private static final String Story_StoryId = MyMemoriesSchema.Story.Cols.STORY_ID;
	private static final String Story_Title = MyMemoriesSchema.Story.Cols.TITLE;
	private static final String Story_Body = MyMemoriesSchema.Story.Cols.BODY;
	private static final String Story_AudioLink = MyMemoriesSchema.Story.Cols.AUDIO_LINK;
	private static final String Story_VideoLink = MyMemoriesSchema.Story.Cols.VIDEO_LINK;
	private static final String Story_ImageName = MyMemoriesSchema.Story.Cols.IMAGE_NAME;
	private static final String Story_ImageMetaData = MyMemoriesSchema.Story.Cols.IMAGE_LINK;
	private static final String Story_Tags = MyMemoriesSchema.Story.Cols.TAGS;
	private static final String Story_CreationTime = MyMemoriesSchema.Story.Cols.CREATION_TIME;
	private static final String Story_StoryTime = MyMemoriesSchema.Story.Cols.STORY_TIME;
	private static final String Story_Latitude = MyMemoriesSchema.Story.Cols.LATITUDE;
	private static final String Story_Longitude = MyMemoriesSchema.Story.Cols.LONGITUDE;
	private static final String Tags_KEY_ID = MyMemoriesSchema.Tags.Cols.ID;
	private static final String Tags_LoginId = MyMemoriesSchema.Tags.Cols.LOGIN_ID;
	private static final String Tags_StoryId = MyMemoriesSchema.Tags.Cols.STORY_ID;
	private static final String Tags_Tag = MyMemoriesSchema.Tags.Cols.TAG;
	// ST:createShortVariables:finish

	// ST:databaseTableCreationStrings:start
	// SQL Statement to create a new database table.
	private static final String DATABASE_CREATE_STORY = "create table " + DATABASE_TABLE_STORY + " (" // start
																									  // table
	        ...
	        + " );"; // end table
	// SQL Statement to create a new database table.
	private static final String DATABASE_CREATE_TAGS = "create table " + DATABASE_TABLE_TAGS + " (" // start
																									// table
	 ...
	 * @param _context
	 */
	public MyMemoriesDataDBAdapter(Context _context) {
	 ...
	 * @param _context
	 */
	public MyMemoriesDataDBAdapter(Context _context, boolean memory_only_db) {
	 ...
	 * 
	 * @return this MyMemoriesDataDBAdapter
	 * @throws SQLException
	 */
	public MyMemoriesDataDBAdapter open() throws SQLException {
		Log.d(LOG_TAG, "open()");
		try {
	 ...
	 */
	public Cursor query(final String table, final String[] projection, final String selection, final String[] selectionArgs, final String sortOrder) {
	...
	private static class myDbHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			// Log version upgrade.
			Log.w(LOG_TAG + "DBHelper", "Upgrading from version " + oldVersion + " to " + newVersion
