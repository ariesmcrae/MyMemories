...
public class MyMemoriesSchema {
	...
	//public static final String PROJECT_NAME = "mymemoriescontentprovider";
	public static final String DATABASE_NAME = "mymemoriescontentprovider.db";
	public static final int DATABASE_VERSION = 1;

	/**
	 * ConentProvider Related Constants
	 */
	//public static final String AUTHORITY = ORGANIZATIONAL_NAME + "." + PROJECT_NAME + ".mymemoriescontentprovider";
	public static final String AUTHORITY = ORGANIZATIONAL_NAME + ".mymemoriescontentprovider";	
	...
	public static class Story {
		...
		public static final String CONTENT_TOPIC = "topic/com.ariesmcrae.mymemories.story";
		...
		public static final String[] ALL_COLUMN_NAMES = { Cols.ID,
		        ...
		        Cols.LOGIN_ID, Cols.STORY_ID, Cols.TITLE, Cols.BODY, Cols.AUDIO_LINK, Cols.VIDEO_LINK, Cols.IMAGE_NAME,
		        Cols.IMAGE_LINK, Cols.TAGS, Cols.CREATION_TIME, Cols.STORY_TIME, Cols.LATITUDE, Cols.LONGITUDE
	...
	public static class Tags {
		...
		public static final String CONTENT_TOPIC = "topic/com.ariesmcrae.tags";

		// ST:relationKeyClause:inline
		public static final String ALL_KEY_CLAUSE;
		static {
			ALL_KEY_CLAUSE = new StringBuilder().append('"').append(Cols.TAG).append('"').append("=?").append(" AND ").append('"')
			        .append(Cols.STORY_ID).append('"').append("=?").append(" AND ").append('"').append(Cols.LOGIN_ID).append('"')
			        .append("=?").toString();
		};

		public static final String[] ALL_KEY_COLUMNS = new String[] { Cols.TAG, Cols.STORY_ID, Cols.LOGIN_ID };
