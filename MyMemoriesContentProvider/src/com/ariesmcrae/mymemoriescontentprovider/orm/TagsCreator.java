...
public class TagsCreator {
	...
	public static ContentValues getCVfromTags(final TagsData data) {
		...
		rValue.put(MyMemoriesSchema.Tags.Cols.LOGIN_ID, data.loginId);
		rValue.put(MyMemoriesSchema.Tags.Cols.STORY_ID, data.storyId);
		rValue.put(MyMemoriesSchema.Tags.Cols.TAG, data.tag);
		return rValue;
	}
	...
	public static TagsData getTagsDataFromCursor(Cursor cursor) {
		...
		long rowID = cursor.getLong(cursor
				.getColumnIndex(MyMemoriesSchema.Tags.Cols.ID));
		long loginId = cursor.getLong(cursor
				.getColumnIndex(MyMemoriesSchema.Tags.Cols.LOGIN_ID));
		long storyId = cursor.getLong(cursor
				.getColumnIndex(MyMemoriesSchema.Tags.Cols.STORY_ID));
		String tag = cursor.getString(cursor
				.getColumnIndex(MyMemoriesSchema.Tags.Cols.TAG));
